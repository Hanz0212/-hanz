...
def build_work_place():
    ...
    shutil.copyfile(os.path.join(curcase_path, testfile_name),
                    os.path.join(run_path,  testfile_name))
    shutil.copyfile(os.path.join(curcase_path, ans_name),
                    os.path.join(run_path, ans_name))
...
error_path = os.path.join(extract_folder, 'error')
