...
A_path = os.path.join(extract_folder, zip_name, 'A')
B_path = os.path.join(extract_folder, zip_name, 'B')
C_path = os.path.join(extract_folder, zip_name, 'C')
