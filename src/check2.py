...
print("ZIP文件解压完成")
A_path = os.path.join(extract_folder, zip_name+' (1)', 'A')
B_path = os.path.join(extract_folder, zip_name+' (1)', 'B')
C_path = os.path.join(extract_folder, zip_name+' (1)', 'C')
error_path = os.path.join(extract_folder, zip_name+' (1)', 'error')


check_cases_at(A_path)
check_cases_at(B_path)
check_cases_at(C_path)
parser_name = error_name
check_cases_at(error_path)
